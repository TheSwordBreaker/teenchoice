...
class Base extends React.Component {
  ...
  render() {
    ...
    if (
      localStorage.getItem("lat1") == localStorage.getItem("lat2") &&
      localStorage.getItem("long1") == localStorage.getItem("long2")
    ) {
      ...
      const Δφ =
        ((localStorage.getItem("lat2") - localStorage.getItem("lat1")) *
          Math.PI) /
        180;
      const Δλ =
        ((localStorage.getItem("long2") - localStorage.getItem("long1")) *
          Math.PI) /
        180;
    ...
    axios("https://3choices.in/profile/que/")
      .then((res) => {
        this.setState({
          datg: res.data.filter(
            ({ username }) => username === localStorage.getItem("curr")
          ),
        });
      })
      .catch((err) => {
        ...
        <div className="wrapper">
          <div className="image-container">
            <Carousel
              ...
              style={{ top: "-266px", position: "relative" }}
            >
              <Carousel.Item>
                <img
                  src={item.image1}
          ...
          <div className="profile-container">
            ...
            <Container>
              ...
              localStorage.getItem("username") ? (
                ...
                <b>
                  <p style={{ color: "white" }}>
                    You're {localStorage.getItem("dist")}Km far from{" "}
                    {localStorage.getItem("curr")}
                  </p>{" "}
                  <Divider></Divider>
                </b>
          ...
          <List.Item>
            ...
            <List.Content>
              ...
              <Label style={{ backgroundColor: "inherit" }}>
                {" "}
                <h6>coffe person or tea person..?</h6>{" "}
              </Label>
            </List.Content>
          </List.Item>
          <List.Item>
            ...
            <List.Content>
              ...
              <Label style={{ backgroundColor: "inherit" }}>
                {" "}
                <h6>cat person or dog person..?</h6>{" "}
              </Label>
            </List.Content>
          </List.Item>
          <List.Item>
            ...
            <List.Content>
              ...
              >
                <h6>Morning person or Evening person..?</h6>
              </Label>{" "}
            </List.Content>
          </List.Item>
        </List>
