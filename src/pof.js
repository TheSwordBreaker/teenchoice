    ...
    return (
      <div class="wrapper-x">
        ...
        {window.innerWidth < 580 ? (
          <div class="profile-container-x" style={{ width: "88%" }}>
            <div
              class="profile-pic-x"
            ...
            {window.innerWidth < 580 ? (
              <h4 style={{ color: "purple" }}>
                <span>{item.parent_user}</span> ({item.Age}){" "}
              </h4>
            ) : (
            ...
            <h4 style={{ color: "purple" }}>{item.location}</h4>
            <br />
            ...
            localStorage.getItem("username") ? (
              ...
              <b>
                <p>
                  ...
                  Km far from {localStorage.getItem("curr")}
                </p>
              </b>
            )}
            <br />
            ...
            localStorage.getItem("username") ? (
              <Button
                style={{ color: "purple" }}
                onClick={() => this.props.history.push(`/pof`)}
              >
                Edit
              </Button>
            ) : (
          ...
          <div class="profile-container-x">
            ...
            localStorage.getItem("username") ? (
              <Button
                style={{ color: "purple" }}
                onClick={() => window.location.assign(`/pof`)}
              >
                Edit
              </Button>
            ) : (
